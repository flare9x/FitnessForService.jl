...
@doc """
    Part4ComponentType(component::String, vessel_orientation::String, material::String, D::Float64,Lss::Float64,H::Float64, NPS::Int64, design_temperature::Float64, units::String)::Array{Int64}

4.4.1.2 Applicability of the Level 1 and Level 2 Assessment Procedures\n
...
""" ->
function Part4ComponentType(component::String; vessel_orientation::String, material::String, D::Float64,Lss::Float64,H::Float64, NPS::Float64, design_temperature::Float64, units::String)::Array{Int64}
    # input data
    # NPS groups
...
if any(component .== ["Pressure Vessel Nozzles","Tank Nozzles","Piping Branch Connections","Reinforcement Zone of Conical Sections","Flanges"])
    print(component," qualifies as a Type B, Class 2 Component\n")
    level_1_satisfied = 0
    level_2_satisfied = 1
    level_3_satisfied = 1
elseif any(component .== ["Cylinder to Flat Head Junction","Integral Tubesheet Connections"])
    print(component," qualifies as a Type B, Class 2 Component\n")
    level_1_satisfied = 0
    level_2_satisfied = 0
    level_3_satisfied = 1
...
@doc """
    Part4AsessmentApplicability(x::Array{Int64}, design::Int64, toughness::Int64, cyclic::Int64, creep_range::Int64)::Array{Int64}
...
""" ->
function Part4AsessmentApplicability(x::Array{Int64}, design::Int64, toughness::Int64, cyclic::Int64, creep_range::Int64)::Array{Int64}
    # level 1
