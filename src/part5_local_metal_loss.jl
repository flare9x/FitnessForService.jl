...
x = Part5ComponentType("Cylindrical Vessel", vessel_orientation="horizontal", material="Carbon and Low Alloy Steels", D=144.0,Lss=96.0,H=1440.0, NPS=0.0, design_temperature=0.0, units="lbs-in-psi")
