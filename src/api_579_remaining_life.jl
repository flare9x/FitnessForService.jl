...
#crate = crate ./ 12 convert to inches per month
...
# time. The time at which the r MAWP curve intersects the equipment design pressure or equipment
...
Guide.title("tmm revised for varying corrosion rates - Years for MAWPr to reach equipment Design P at varying corrosion rates (ipy)"), Guide.xlabel(x_label),Guide.ylabel("MAWPr"),
yintercept=[P],
