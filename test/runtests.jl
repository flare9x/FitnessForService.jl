...
@testset "part5_LTA_functions.jl" begin
    @testset "Non Groove Part 5 LTA Level 1 Assessment" begin
        ...
        part_5_lta_level_1_output = Part5LTALevel1(CTPGrid; tmm_forcing=false, tmm=0.0, annex2c_tmin_category="Straight Pipes Subject To Internal Pressure", equipment_group="piping",flaw_location="external",FCA_string="external",metal_loss_categorization="LTA",units="lbs-in-psi",Lmsd=12.0, tnom=.3,
